  ...
  return (
    <>
      ...
      <div className="sticky-wrapper relative" style={{ height: "180vh" }}>
        <div
          ref={containerRef}
          className="sticky-content sticky top-0 h-screen w-[95%] mx-auto overflow-hidden border"
        ...
        >
          ...
          <div className="fifthPara-1 relative pt-[4vw]">
            <div className="h-fit w-fit overflow-hidden">
              <p className="uppercase text-[#FF3A65] px-[0.3vw] bg-[#FF3A651A] text-[0.8vw] flex items-center gap-[0.5vw] ml-[0.3vw]">
                <Image
          ...
          <div className="flex">
            <div className="firstHeading absolute top-[9.5vw]">
              <div className="h-fit overflow-hidden">
                <h1 className="text-[8vw] leading-[8vw] text-white font-bebas">
                  custom threads
                </h1>
              </div>
              <div className="h-fit overflow-hidden">
                <h1 className="text-[8vw] leading-[7.5vw] text-white font-bebas">
                  your way
                </h1>
              </div>
            </div>
            <div className="secondHeading absolute top-[13vw]">
              <div className="h-fit overflow-hidden">
                <h1 className="text-white font-bebas text-[6.5vw] leading-[5vw]">
                  best sellers
                </h1>
              </div>
            </div>
          ...
          <div className="fifthPara-3 flex flex-col absolute top-[18vw] text-white">
            <span className="font-bebas left-[2.5vw] text-[#828282] text-[0.9vw] leading-[0.8vw]">
              t-shirt
            </span>
            ...
            <span className="uppercase inline-block text-[1.2vw]">$ 1,250</span>
          </div>

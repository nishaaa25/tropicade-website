...
const Landing = () => {
    ...
    useGSAP(()=>{
        ...
        tl.to(firstAnime.current, {
            y: -200,
            duration: 1,
            ease: "back.inOut"
        }, "variable")
        tl.to(secondAnime.current, {
            y: -200,
            duration: 1.4,
            ease: "back.inOut"
        }, "variable")
        tl.to(thirdAnime.current, {
            y: -200,
            duration: 1.8,
            ease: "back.inOut"
        }, "variable")
        tl.to(fourthAnime.current, {
            y: -200,
            duration: 2.2,
            ease: "back.inOut"
        }, "variable")
        tl.to(sixthAnime.current, {
            y: -200,
            duration: 2.6,
            ease: "back.inOut"
        }, "variable")
        tl.to(seventhAnime.current, {
            y: -200,
            duration: 3,
            ease: "back.inOut"
        }, "variable")
        tl.to(fifthAnime.current, {
            y: -200,
            duration: 3.4,
            ease: "back.inOut"
        }, "variable")
        ...
        tl.to(eighthAnime.current, {
            top: "0%",
            duration: 1,
            ease: "back.inOut"
        }, "var")
        tl.to(ninthAnime.current, {
            top: "0%",
            duration: 1.4,
            ease: "back.inOut"
        }, "var")
                ...
                <div
                    ...
                    <div className="relative pt-[8vw]">
                        <div className="h-fit overflow-hidden ml-[0.8vw]">
                            <p ref={firstAnime} className="uppercase text-white font-bold">make it yours</p>
                        </div>
                    </div>
                    <div className="flex">
                        <div className="firstHeading absolute top-[9.5vw]">
                            <div className="h-fit overflow-hidden">
                                <h1 ref={secondAnime} className="text-[8vw] leading-[8vw] text-white font-bebas">custom threads</h1>
                            </div>
                            <div className="h-fit overflow-hidden">
                                <h1 ref={thirdAnime} className="text-[8vw] leading-[7.5vw] text-white font-bebas">your way</h1>
                            </div>
                        </div>
                    </div>
                    <div className="absolute h-fit overflow-hidden top-[26.5vw] ml-[0.5vw]">
                        <p ref={sixthAnime} className="text-[#979797] font-[300] leading-[1.2]">Bring your memories, faces, and moments to life — right on your tee.</p>
                        <p ref={seventhAnime} className="text-[#979797] font-[300]">At Tropicade, we blend bold street vibes with personal stories.</p>
                    </div>
                    ...
                    <div className="h-screen w-1/2">
                        <div className="relative h-[40px] overflow-hidden">
                            <p ref={eighthAnime} className="uppercase text-[#FF3A65] px-[0.3vw] py-[0.3vw] bg-[#FF3A651A] text-[0.8vw] flex items-center gap-[0.5vw] ml-[0.3vw] absolute top-[100%]">
                        ...
                        <div className="h-[150px] relative w-full overflow-hidden">
                            <h1 ref={ninthAnime} className="text-white whitespace-nowrap font-bebas text-[6.5vw] leading-none absolute top-[100%]">best sellers</h1>
                        </div>
                        <div className="flex flex-col text-white h-[120px]">
                            <div className="h-[20px] overflow-hidden relative">
                                <span ref={twelweAnime} className="font-bebas text-[#828282] text-[0.9vw] leading-[0.8vw] absolute top-[100%]">t-shirt</span>
                            </div>
                            <div className="h-[40px] overflow-hidden relative">
                                <div ref={thirteenAnime} className="gap-[0.5vw] flex items-center absolute top-[100%]">
                            ...
                            <div className="h-[35px] overflow-hidden relative">
                                <span ref={fourteenAnime} className="uppercase inline-block text-[1.2vw] absolute top-[100%]">
                                    $ 1,250
                                </span>
                            </div>
                        </div>
                        <div className="h-[140px] relative w-full overflow-hidden">
                            <div ref={tenthAnime} className="flex gap-[1vw] ml-[0.3vw] relative top-[100%]">
                                <button 
                        ...
                        <div className="ml-[0.3vw] gap-[1vw] h-[50px] relative overflow-hidden">
                            <button ref={eleventhAnime} className="px-[2.5vw] py-[0.5vw] gap-[1vw] bg-dark-pink-500 text-white uppercase flex-center absolute top-[100%]">

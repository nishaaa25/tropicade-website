...
const Landing = () => {
    ...
    useGSAP(() => {
        ...
        const animateToInitial = () => {
            ...
            // Bring back original content - set to their final positions first, then animate
            tl.set([".firstHeading h1", ".firstHeading div", ".fifthPara p", ".fifthPara div", ".thirdPara", ".fourthButton button"], {
                y: -150,
                opacity: 0
            }, 0.2)

            tl.set(bottomAnime.current, {
                y: 400,
                opacity: 0
            }, 0.2)

            // Now animate them back to their original positions
            tl.to([".firstHeading h1"], {
                y: 0,
                opacity: 1,
                duration: 0.8,
        ...
        const handleScroll = () => {
            ...
            const threshold = 50 // Minimum scroll distance to trigger animation

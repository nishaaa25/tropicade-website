...
import { LoaderContext } from "../../app/page"
...
const Landing = () => {
    ...
    const { isLoaderComplete } = useContext(LoaderContext)

    useGSAP(() => {
        // Only run animations if loader is complete
            ...
            <div className="sticky-wrapper" style={{ height: '200vh' }}>
                <div
                    ...
                    <div className="fifthPara-3 ml-1">
                        <div className="flex flex-col absolute top-[18rem] text-white">
